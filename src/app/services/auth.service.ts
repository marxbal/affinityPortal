...
export class AuthService {
 ...
 callNonAuth(action: string, param: any){
   ...
   return this.http.post(action, param, {headers})
     .pipe(map((res: any) => {
       if (res) {
         return res;
       }
 ...
 callNonAuthPaginated(action: string, param: any, page: string, size: string){
   ...
   return this.http.post(mainAction, param, {headers})
     .pipe(map((res: any) => {
       if (res) {
         return res;
       }
 ...
 callPaginated(action: string, param: any, page: string, size: string){
  ...
  doCallServiceGet(action: string, param : any): Observable<any>{
      ...
      action = "https://ifae.com.ph:2083" + action;
       ...
       return this.http.get(action, {headers})
         .pipe(map((res: any) => {
           if (res) {
             return res;
           }
  ...
  checkWsdl() {  
    return this.http.post(this.apiUrl + '/marsh/cocaf/checkWsdl','',{responseType:"text"}).pipe(
     map((res : string)  => {
        return res;
      }));
  }
  ...
  generatePDF(param : any): Observable<any>{
    return this.http.post("/api/util/pdf", param, {  responseType: 'blob' })
       .pipe(map((res: any) => {
         if (res) {
            let blob = new Blob([res], {type: "application/pdf"});
  ...
  generateExcel(param : any): Observable<any>{
    return this.http.post("/api/util/excel", param, {  responseType: 'blob' })
       .pipe(map((res: any) => {
         if (res) {
  ...
  generateExcelReport(param : any): Observable<any>{
    return this.http.post("/api/util/excelProdReport", param, {  responseType: 'blob' })
       .pipe(map((res: any) => {
         if (res) {
            let blob = new Blob([res], {type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"});
            let fileName = param.reportFileName;
